...
namespace 
{
	...
	void simulateSensorReadings(vector<int> &sensor_reading_nums, vector<vector<rel_vec> > &sensor_readings, vector<point_2d> landmark_map_for_sim)
	{
		rel_vec odom_ideal; odom_ideal.r=1; odom_ideal.theeta=0;
	    td_pose robot_pose_curr;
	    robot_pose_curr.x = 0; robot_pose_curr.y = 0; robot_pose_curr.theeta = pi/4;
...
int main(int argc, char** argv) 
{
	...
	simulateSensorReadings(sensor_reading_nums, sensor_readings, landmark_map_for_sim);
